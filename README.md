...
- 📋 **Поддержка плейлистов** — на странице плейлиста (URL содержит `&list=...`) yt-dlp скачивает сразу все видео из плейлиста
...
> **Плейлисты:** если страница содержит параметр `&list=...` (например, `youtube.com/watch?v=...&list=...`), yt-dlp определяет это как плейлист и скачивает все видео из него целиком. Никаких дополнительных действий не требуется — просто нажми скачать.
...
Вы можете использовать, модифицировать и распространять его как угодно — на свой страх и риск.
